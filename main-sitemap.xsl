			...
			<head>
				<xsl:choose>
					<xsl:when test="kml:kml">
						<title>Locations Sitemap - King Land Clearing</title>
					</xsl:when>
					<xsl:otherwise>
						<title>XML Sitemap - King Land Clearing</title>
					</xsl:otherwise>
				</xsl:choose>
				...
				<xsl:choose>
					<xsl:when test="kml:kml">
						...
						<div id="content">
							...
							<p class="expl">
								<a href="https://f1leads.github.io/klcstaticsite/sitemap_index.xml">&#8592; Sitemap Index</a>							</p>
